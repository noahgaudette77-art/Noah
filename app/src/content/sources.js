...
export const SOURCES = [
  ...
  s("finnhub", "Finnhub", 2, "key",
    "https://finnhub.io/docs/api",
    "Delayed end-of-day equity quotes and company profiles. The only paid-tier-style source here, and the only way this platform can see a share price at all. Free key, 60 requests a minute.",
    { region: "global", topics: ["markets", "companies"], format: "json",
      requirement: "The key is read from INTEL_EQUITY_KEY in the pipeline and never written into a snapshot or shipped to the browser. Quotes are delayed; this is not a real-time feed." }),
  s("alphavantage", "Alpha Vantage", 2, "key",
    "https://www.alphavantage.co/documentation/",
    "Equity quotes. Implemented as an alternative price provider, but its free tier allows 25 requests a day, which cannot cover the tracked companies in a single run.",
    { region: "global", topics: ["markets", "companies"], format: "json",
      requirement: "Same handling as Finnhub: INTEL_EQUITY_KEY, pipeline only, never in a snapshot." }),
