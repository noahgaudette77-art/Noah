        ...
        panel({
          ...
          body: h("div.tbl-wrap", null, h("table.tbl.tbl--zebra", null,
            ...
            h("tbody", null, ...SOURCES.map((source) => h("tr", { id: source.id },
              ...
              h("td.dim", { style: { fontSize: "var(--t-small)" } },
                source.note,
                // A recorded condition of use that is never shown is not honoured.
                source.requirement ? h("div", { style: { marginTop: "var(--s2)" } },
                  h("span.eyebrow", { style: { marginRight: "var(--s2)" } }, "Condition"),
                  h("span.dim2", source.requirement)) : null)))))),
          foot: h("span", null,
            ...
            "Where a source attaches a condition to its use — a declared identity, an attribution obligation — that condition is stated here and honoured in the pipeline."),
        })),
