...
const COMMANDS = [
  ...
  { id: "cmd-markets", label: "Markets", hint: "Equities, volatility, commodities, credit, yields", route: "/markets" },
  { id: "cmd-economy", label: "Economy", hint: "Indicators and structure", route: "/economy" },
  { id: "cmd-politics", label: "Politics", hint: "Policy as primary documents", route: "/politics" },
